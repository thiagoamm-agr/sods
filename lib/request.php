...
$query = mysql_query("insert into solicitacao (solicitante_id, detalhamento, info_adicionais, observacoes, tipo_solicitacao_id) 
		values ($solicitante_id , '$desc', '$info_add', '$obs', $tipo_sol)") or die(mysql_error());
