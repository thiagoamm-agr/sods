<?php
    ...
    class Paginator {
        ...
        function __construct() {
            ...
            // 1: advance, 0: normal, 2: pager
            $this->paginationstyle = 0;
            // in case of ajax pagination
            $this->defaultUrl = "#";
            // # incase of ajax pagination e.g index.php?p=[p]
            $this->paginationUrl = "#";
            ...
            if ($this->totalrecords > $this->pagesize) {
                ...
                if ($this->pagenumber > 1) {
                    if ($this->showfirst && $this->paginationstyle != 2) {
                        ...
                        $paginationlst .= "<li><a id=\"p_1\" href=\"" . $this->defaultUrl . 
                    ...
                    $paginationlst .= "<li" . $prevPageCss . "><a id=\"pp_" . $pid . "\" href=\"" . 
                        $this->prepareUrl($pid) . 
                        "\" data-toggle=\"tooltip\" class=\"pagination-css\" title=\"" . 
                        $tooltip . "\">" . $prevIcon . "</a></li>\n";
                    // Normal Links
                    if ($this->paginationstyle != 2) {
                        $paginationlst .= $this->generate_pagination_links(
                            $totalpages, 
                            $this->totalrecords, 
                            $this->pagenumber, 
                            $this->pagesize
                    ...
                    if ($this->pagenumber < $totalpages) {
                        $paginationlst .= $this->generate_previous_last_links(
                            $totalpages, 
                            $this->totalrecords, 
                            $this->pagenumber, 
                            $this->pagesize, 
        ...
        function generate_pagination_links($totalpages, $totalrecords, $pagenumber, $pagesize) {
            ...
            if(count($arr) > 0) {
                foreach ($arr as $item){
                    ...
                    $script .= "<li" . $css . "><a id=\"pg_" . $item . "\" href=\"" . 
        ...
        function generate_previous_last_links($totalpages, $totalrecords, $pagenumber, $pagesize, $showlast) {
            ...
            $script .= "<li" . $nextPageCss . "><a id=\"pn_" . $pid . "\" href=\"" . 
                $this->prepareUrl($pid) . 
                "\" class=\"pagination-css\" data-toggle=\"tooltip\" title=\"" . 
                $tooltip . "\">" . $nextPageIcon . "</a></li>\n";
            if ($showlast && $this->paginationstyle != 2) {
                ...
                $script .= "<li><a id=\"pl_" . $totalpages . "\" href=\"" . 
                    ...
                    "\" class=\"pagination-css\" data-toggle=\"tooltip\" title=\"" . 
                    $tooltip . "\"><i class=\"glyphicon glyphicon-forward\"></i></a></li>\n";
            }
            return $script;
        }
